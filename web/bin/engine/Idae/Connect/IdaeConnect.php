<?php
	 ...
	 */
	class IdaeConnect extends \MongoClient {
		...
		private function set_scheme_model_instance() {
			...
			$this->appscheme_model_instance                 = $this->selectMongoCollection(self::appscheme_model_name);
			$this->appscheme_base_model_instance            = $this->selectMongoCollection(self::appscheme_base_model_name);
			$this->appscheme_field_model_instance           = $this->selectMongoCollection(self::appscheme_field_model_name);
			$this->appscheme_field_group_model_instance     = $this->selectMongoCollection(self::appscheme_field_group_model_name);
			$this->appscheme_field_type_model_instance      = $this->selectMongoCollection(self::appscheme_field_type_model_name);
			$this->appscheme_has_field_model_instance       = $this->selectMongoCollection(self::appscheme_has_field_model_name);
			$this->appscheme_has_table_field_model_instance = $this->selectMongoCollection(self::appscheme_has_table_field_model_name);
		}
