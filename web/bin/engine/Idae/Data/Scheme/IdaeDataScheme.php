...
class IdaeDataScheme extends IdaeDB
{
		...
		public function __construct($table = '', $param_draoit_fields = [])
		{
				...
				$this->IdaeQuery      = new IdaeQuery($table);
				$this->SchemeInstance = SchemeInstance::getInstance();
		...
		public function get_model_to_drawer()
		{ // Mini Table ...
				$out_groups = [];
		...
		public function set_schemeFieldGroupByMode($fieldGroupBy = null)
		{ // group , type , Grp , Type
		...
		private function set_scheme_fields()
		{
				...
				$this->scheme_fields = $this->SchemeInstance->appscheme_has_field_model_instance->find(['idappscheme' => (int)$this->table_id], $options);
