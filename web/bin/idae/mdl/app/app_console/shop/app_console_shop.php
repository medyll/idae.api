...
<div class="flex_v" style="height:100%;overflow:hidden;">
	<div class="padding align-center flex_h flex_align_middle flex_padding boxshadowb <?=$css_entete ?>">
		...
		<div style="font-size: 3em" class="text-bold" data-count_<?=$type_session?>="commande" data-<?=$notify_count_id?>="<?= $idtype_session ?>" data-type_session="<?= $type_session ?>" data-<?= $name_idtype_session ?>="<?= $idtype_session ?>">
			<?= $rs_app->count(); ?>
		</div>
