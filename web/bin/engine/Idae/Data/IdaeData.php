...
class IdaeData extends IdaeConnect
{
		...
		public function getBaseList($args = [])
		{
				...
				return $conn->find($args)->sort(['ordreAppscheme' => 1]);
		 ...
		 * @throws \MongoCursorException
		 */
		public function getSchemeList($args = [], $sort = ['ordreAppscheme' => 1])
		{
		...
		public function getSchemeFieldList($codeAppscheme, $sort = [])
		{
				...
				return $conn->find(['schemeCode' => $codeAppscheme])->sort($sort);
		}
